export default function MessageIcon({
  ...
  return (
    ...
    >
      <g clipPath="url(#clip0_81_50077)">
        <path
          d="M17.9655 4.15649L11.652 10.47C10.948 11.1722 9.99431 11.5665 9 11.5665C8.00569 11.5665 7.05197 11.1722 6.348 10.47L0.0345 4.15649C0.024 4.27499 0 4.38224 0 4.49999V13.5C0.00119089 14.4942 0.396661 15.4473 1.09966 16.1503C1.80267 16.8533 2.7558 17.2488 3.75 17.25H14.25C15.2442 17.2488 16.1973 16.8533 16.9003 16.1503C17.6033 15.4473 17.9988 14.4942 18 13.5V4.49999C18 4.38224 17.976 4.27499 17.9655 4.15649Z"
          fill="#858D9D"
        />
        <path
